...
class KENTE_DataLoader(DataLoader):
    ...
    def __init__(self):
        ...
        self.data_path = "/content/drive/My Drive/Dr Eglash/Kente_Cloth_Authentication/oc-nn/data/mnist/"
        ...
        self.rcae_results = "/content/drive/My Drive/Dr Eglash/Kente_Cloth_Authentication/oc-nn/reports/figures/MNIST/RCAE/"

        #self.modelsave_path = "/content/drive/My Drive/2018/Colab_Deep_Learning/one_class_neural_networks/models/MNIST/RCAE/"
        self.modelsave_path = "/content/drive/My Drive/Dr Eglash/Kente_Cloth_Authentication/oc-nn/models/MNIST/RCAE/"
    ...
    def load_data(self, original_scale=False,):
        ...
        if Cfg.ad_experiment:
            ...
            n_norm_split = int(Cfg.kente_val_frac * n_norm)
            n_out_split = int(Cfg.kente_val_frac * n_out)
